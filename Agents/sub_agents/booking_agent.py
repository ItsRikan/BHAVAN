...
booking_agent = Agent(
    ...
    1) book room using the book_room tool.
            ...
            - If the user denied it ask the user for a feedback and use get_feedback tool with sentiment negative
    2) check out a client or cancelation of a current booked room. use the room_checkout_confirmation tool to confirm the user and ask for payment method.
            ...
            - Finally ask the user if he wants to provide any feedback if yes then use get_feedback tool to save it
    """,
    tools=[
